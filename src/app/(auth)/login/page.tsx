        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full text-black px-4 py-3 border border-gray-300 outline-none rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orgring-orange-500 transition-all duration-200"
              required
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full text-black px-4 py-3 border border-gray-300 outline-none rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orring-orange-500 transition-all duration-200"
              required
            />
          </div>
        </div>
